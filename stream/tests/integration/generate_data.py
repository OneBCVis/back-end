...
txn_pool = []
prev_block_hash = "0x" + ''.join(random.choices('0123456789abcdef', k=16))
miners = ["0x" + ''.join(random.choices('0123456789abcdef', k=16))
          for _ in range(10)]
...
def generate_random_txn():
    global txn_pool
    txn = {}
    txn["Hash"] = "0x" + ''.join(random.choices('0123456789abcdef', k=16))
    txn["Status"] = 'PENDING'
...
def generate_random_block():
    ...
    block = {}
    block["Hash"] = "0x" + ''.join(random.choices('0123456789abcdef', k=16))
